...
var api = {
  ...
  token: "2f6ee448a14bbfbde0ae353360e6e3a0", // TODO 0 add your api key - DONE
  /**
...
function searchMovies(query, callback) {
  ...
  $.ajax({
    //url: api.root + "/search/movie",//change the url so that we search for keywords, not movies
    ...
    success: function(response) {
      ...
      var keywordsIDs = response.results.map(function(keywordObj){
       return keywordObj.id;
       
      });
      console.log(keywordsIDs);
      var keywordsString = keywordsIDs.join("|");
